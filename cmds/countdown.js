...
module.exports.run = async (gideon, message, args) => {
    ...
    snekfetch.get(flashapi).then(r => {
        ...
        .setDescription(`${flatitle} ${flaseason}x${flanumber<10?"0"+flanumber:flanumber} - ${flaepname}\nairs in ${fladiffDays} ${d} on ${ad.toDateString} at ${flatimeString} ET on ${flachannel}`)
