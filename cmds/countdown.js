            ...
            snekfetch.get(supergirlapi).then(r => {
                ...
                snekfetch.get(legendsapi).then(r => {
                    ...
                    snekfetch.get(bwomanapi).then(r => {
                        ...
                        .addField(`${bwtitle} ${bwseason}x${bwnumber<10?"0"+bwnumber:bwnumber} - ${bwepname}`, `Will air in ${fladiffDays} ${d} on ${flaad.toDateString()} at ${flatimeString} ET on ${flachannel}`)
	                    .setThumbnail()
    	                .setTimestamp()
