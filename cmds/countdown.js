...
module.exports.run = async (gideon, message, args) => {
    ...
    snekfetch.get(flashapi).then(r => {
        ...
        .addTitle(`${flatitle} ${flaseason}x${flanumber<10?"0"+flanumber:flanumber} - ${flaepname}`, `airs in ${fladiffDays}on ${fladay}, ${fladate.toDateString()} at ${flatime} on ${flachannel}`)
