...
module.exports.run = async (gideon, message, args) => {
    ...
    if (!args[0]) {
        ...
        .addField('Meta-human physiology', 'Vibers possess altered DNA and physiology to access dimensional energy.')  
        ...
        .setColor('#2791D3')
        .setTitle('__Kryptonians possess the following abilities:\n(Only when exposed to a yellow sun\'s energy)__')
        .addField('X-ray vision', 'Kryptonians possess the ability to see through objects, except for lead.')  
