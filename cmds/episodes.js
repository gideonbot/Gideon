...
module.exports.run = async (gideon, message, args) => {
    ...
    let show = args.toString().substring(4, args.length -4)
    let showarg = Array.prototype.slice.call(show);
    let showid = '';
    let showtitle = '';
    ...
    if (show.includes(fl)){
        ...
        return message.channel.send(`"${showarg.join('')}" is not a valid argument!`)
    }  
