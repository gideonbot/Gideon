...
module.exports.run = async (gideon, message, args) => {
    const crossovers = new Discord.RichEmbed()
        ...
        .addField('Crisis On Infinite Earths', 'The Flash 6x09 - Crisis on Infinite Earths, Part 1\nArrow 8x09 - Crisis on Infinite Earths, Part 2 DC\'s Legends of Tomorrow 5x09 - Crisis on Infinite Earths, Part 3  Supergirl 5x09 - Crisis on Infinite Earths, Part 4 Batwoman 1x09 - Crisis on Infinite Earths, Part 5')
        .setTimestamp()
