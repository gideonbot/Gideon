...
module.exports.run = async (gideon, message, args) => {
    const crossovers = new Discord.RichEmbed()
	    .setColor('#2791D3')
	    .setTitle('__All Arrowverse crossover episodes in ther respective watching order:__')
