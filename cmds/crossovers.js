...
module.exports.run = async (gideon, message, args) => {
    const crossovers = new Discord.RichEmbed()
        ...
        .addField('Crisis On Infinite Earths', 'The Flash 6x08 - Crisis on Infinite Earths, Part 1\nArrow 8x08 - Crisis on Infinite Earths, Part 2\nDC\'s Legends of Tomorrow 5x08 - Crisis on Infinite Earths, Part 3\nSupergirl 5x08 - Crisis on Infinite Earths, Part 4\nBatwoman 1x08 - Crisis on Infinite Earths, Part 5')
        .setTimestamp()
