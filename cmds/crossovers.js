...
module.exports.run = async (gideon, message, args) => {
    ...
    const crossovers = new Discord.RichEmbed()
        ...
        .addField('Crisis on Earth-X', 'Supergirl 3x08 - Crisis on Earth-X, Part 1Arrow 6x08 - Crisis on Earth-X, Part 2The Flash 4x08 - Crisis on Earth-X, Part 3DC\'s Legends of Tomorrow 3x08 - Crisis on Earth-X, Part 4')  
