...
export async function run(message) {
    const co1 = Util.Embed('__All Arrowverse crossover episodes in their respective watching order:__', null, message.member)
    ...
    const co2 = Util.Embed('__All Arrowverse crossover episodes in their respective watching order:__', null, message.member)
