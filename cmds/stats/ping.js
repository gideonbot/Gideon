...
export async function run(message) {
    ...
    Util.fetchJSON('https://discord.com/api/v7/gateway').then(() => {
        ...
        message.channel.send(Util.Embed('The fastest bot alive!', {description: `WebSocket ping: ${process.gideon.ws.ping.toFixed(2)} ms\nREST ping: ${took} ms\ngideonbot.com ping: ${ping} ms`}, message.member));
    }, failed => {
        console.log(failed);
