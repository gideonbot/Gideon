...
export async function CVM(gideon: Client, message: Message): Promise<void | Message> {
...
export async function Ads(gideon: Client, message: Discord.Message): Promise<void | Discord.Message> {
