...
export async function run(interaction: CommandInteraction): Promise<void> {
	...
	const attacks = [
		...
		},
		{
			...
			emote: ':star:',
			attackgif:
				'https://66.media.tumblr.com/9830cb974e42d024ce1890a3947a16bf/3a843c4c812f8703-f6/s540x810/71fdbfc786435b9db329244a4db1e2d2cc912ad6.gif'
		},
		{
	...
	return interaction.reply({
		embeds: [
			new MessageEmbed()
				...
				.setImage(attack?.attackgif as string)
		]
	});
}
