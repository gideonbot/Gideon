class MsgHandler {
    ...
    static async Handle(message, Util, connection) {
        ...
        try {
            ...
            if (command.help.name === 'eval') return message.channel.send(Util.Embed().setTitle('An error occurred while processing your request:').setDescription('```\n' + e + '```'));
